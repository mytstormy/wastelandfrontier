...
"metadata"      => 'Metadata (ראו <a href="$1">$1</a> למידע נוסף):',
...
"undelete_short"    => "שחזר $1 עריכות",
"undelete_short1"   => "שחזר עריכה אחת",
"protect"           => "הגן",
...
"viewcount"         => "דף זה נצפה {{plural:$1|פעם אחת|$1 פעמים}}.",
...
"noconnect"            => "ניסיון ההתחברות לבסיס הנתונים על $1 לא הושלם בהצלחה",
...
"cannotdelete"         => "מחיקת הדף או התמונה לא הושלמה בהצלחה. (יתכן שהוא נמחק כבר על־ידי מישהו אחר.)",
...
"revisionasofwithlink"        => "גרסה מתאריך $1; $2<br />$3 | $4",
"previousrevision"            => "→ הגרסה הקודמת",
"nextrevision"                => "הגרסה הבאה ←",
"currentrevisionlink"         => "צפו בגרסה נוכחית",
"cur"                         => "נוכ",
"next"                        => "הבא",
"last"                        => "אחרון",
"orig"                        => "מקור",
...
"group-bureaucrat-name" => "ביורוקרט",
"group-bureaucrat-desc" => "קבוצת הביורוקרטים יכולה למנות מפעילי מערכת",
...
"uploadnewversion"          => "[$1 העלו גרסה חדשה של קובץ זה]",
...
"subcategorycount"       => "בקטגוריה זו $1 קטגוריות משנה.",
...
"recreate"            => "צור מחדש",
"tooltip-recreate"    => "צור מחדש את הדף שנמחק",
