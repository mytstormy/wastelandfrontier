...
mysql_select_db ($dbname);
	...
	$sql2 = "SELECT *
	        FROM tbl_vehicles
			WHERE vehicle_shield_hp < vehicle_max_shield_hp";
	...
	$result2 = mysql_query($sql2) or die('Query failed. ' . mysql_error()); 
			...
			while($resultfetch2 = mysql_fetch_array($result2,MYSQL_ASSOC)){
				...
				$new_vehicle_shield_hp = $resultfetch2['vehicle_shield_hp'] + $resultfetch2['vehicle_shield_hp_regen'];
...
<p>Cron1.  </p>
<p>This cron updates user energy.  </p>
<p>Done.</p>
